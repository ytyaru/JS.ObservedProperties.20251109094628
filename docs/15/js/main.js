...
//    a.t(-2===Math.roundToEven(-1.5)); // 最近接偶数丸め
    ...
    a.t('quantity unsafedFinite finite float roundableFloat rounderFloat roundFloat roundToEvenFloat floorFloat truncFloat ceilFloat integer numberDecimal'.split(' ').every(n=>'function'===typeof Obs.T[n]))
    a.t('quant unFin fin flt roundable rounder round roundToEven floor trunc ceil int numDec'.split(' ').every(n=>'function'===typeof Obs.T[n]))
