...
//        van.tags.p('After assigning a value, perform any processing.'),
    ...
    */
    ...
    const O = new Obs({some:{value:123}},{msg:{value:'MSG'}});
    O.$.msg;
...
//    a.e(TypeError, `'setup' は予約済みキー名です。他の名前にしてください。予約済み名一覧:constructor,setup`, ()=>{new Obs({setup:{value:0}})});
//    a.e(TypeError, `'$' は予約済みキー名です。他の名前にしてください。予約済み名一覧:constructor,setup`, ()=>{new Obs({'$':{value:0}})});
//    a.e(TypeError, `'_isProxy' は予約済みキー名です。他の名前にしてください。予約済み名一覧:constructor,setup`, ()=>{new Obs({_isProxy:{value:0}})});
    const RESERVED = 'setup,$,_isProxy';
    a.e(TypeError, `'setup' は予約済みキー名です。他の名前にしてください。予約済み名一覧:${RESERVED}`, ()=>{new Obs({setup:{value:0}})});
    a.e(TypeError, `'$' は予約済みキー名です。他の名前にしてください。予約済み名一覧:${RESERVED}`, ()=>{new Obs({'$':{value:0}})});
    a.e(TypeError, `'_isProxy' は予約済みキー名です。他の名前にしてください。予約済み名一覧:${RESERVED}`, ()=>{new Obs({_isProxy:{value:0}})});
    a.t(()=>{
        const o = new Obs({constructor:{value:0}}); // 予約済み名でなく例外も出ないこと
        return 0===o.constructor;
    });
    a.t(()=>{
        const o = new Obs({toString:{value:0}}); // 予約済み名でなく例外も出ないこと
        return 0===o.toString;
    });
    a.t(()=>{
        const o = new Obs({some:{value:123}});
