(function(){
class ID128 {// 128bit長のバイナリをBase64URLで表現する（モジュロバイアス無し。但しto(),from()でradix=2,8,16,32,64,128,256以外を入力するとバイアスが出る）
    ...
    static to(base64URL, radixOrChars=62) {
    ...
    static from(baseN, radixOrChars=62) {
